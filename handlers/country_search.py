...
# ════════════════════════════════════════════════════════════════
# (Именит., Предложный "в ___", Дательный "по всему/всей ___")
COUNTRY_NAMES_RU: dict[str, tuple[str, str, str]] = {
    "AE": ("ОАЭ",          "ОАЭ",             "всем ОАЭ"),
    "TR": ("Турция",       "Турции",           "всей Турции"),
    "TH": ("Таиланд",      "Таиланде",         "всему Таиланду"),
    "CN": ("Китай",        "Китае",            "всему Китаю"),
    "EG": ("Египет",       "Египте",           "всему Египту"),
    "GR": ("Греция",       "Греции",           "всей Греции"),
    "ES": ("Испания",      "Испании",          "всей Испании"),
    "IT": ("Италия",       "Италии",           "всей Италии"),
    "FR": ("Франция",      "Франции",          "всей Франции"),
    "DE": ("Германия",     "Германии",         "всей Германии"),
    "CZ": ("Чехия",        "Чехии",            "всей Чехии"),
    "HU": ("Венгрия",      "Венгрии",          "всей Венгрии"),
    "AT": ("Австрия",      "Австрии",          "всей Австрии"),
    "NL": ("Нидерланды",   "Нидерландах",      "всем Нидерландам"),
    "PL": ("Польша",       "Польше",           "всей Польше"),
    "FI": ("Финляндия",    "Финляндии",        "всей Финляндии"),
    "SE": ("Швеция",       "Швеции",           "всей Швеции"),
    "NO": ("Норвегия",     "Норвегии",         "всей Норвегии"),
    "DK": ("Дания",        "Дании",            "всей Дании"),
    "PT": ("Португалия",   "Португалии",       "всей Португалии"),
    "SG": ("Сингапур",     "Сингапуре",        "всему Сингапуру"),
    "MY": ("Малайзия",     "Малайзии",         "всей Малайзии"),
    "ID": ("Индонезия",    "Индонезии",        "всей Индонезии"),
    "VN": ("Вьетнам",      "Вьетнаме",         "всему Вьетнаму"),
    "IN": ("Индия",        "Индии",            "всей Индии"),
    "JP": ("Япония",       "Японии",           "всей Японии"),
    "KR": ("Южная Корея",  "Южной Корее",      "всей Южной Корее"),
    "US": ("США",          "США",              "всем США"),
    "CA": ("Канада",       "Канаде",           "всей Канаде"),
    "AU": ("Австралия",    "Австралии",        "всей Австралии"),
    "MV": ("Мальдивы",     "Мальдивах",        "всем Мальдивам"),
    "LK": ("Шри-Ланка",    "Шри-Ланке",        "всей Шри-Ланке"),
    "CY": ("Кипр",         "Кипре",            "всему Кипру"),
    "MT": ("Мальта",       "Мальте",           "всей Мальте"),
    "HR": ("Хорватия",     "Хорватии",         "всей Хорватии"),
    "RS": ("Сербия",       "Сербии",           "всей Сербии"),
    "GE": ("Грузия",       "Грузии",           "всей Грузии"),
    "AM": ("Армения",      "Армении",          "всей Армении"),
    "AZ": ("Азербайджан",  "Азербайджане",     "всему Азербайджану"),
    "KZ": ("Казахстан",    "Казахстане",       "всему Казахстану"),
    "UZ": ("Узбекистан",   "Узбекистане",      "всему Узбекистану"),
    "BY": ("Беларусь",     "Беларуси",         "всей Беларуси"),
    "IL": ("Израиль",      "Израиле",          "всему Израилю"),
    "JO": ("Иордания",     "Иордании",         "всей Иордании"),
    "MA": ("Марокко",      "Марокко",          "всему Марокко"),
    "TN": ("Тунис",        "Тунисе",           "всему Тунису"),
    "MX": ("Мексика",      "Мексике",          "всей Мексике"),
    "BR": ("Бразилия",     "Бразилии",         "всей Бразилии"),
    "TJ": ("Таджикистан",  "Таджикистане",     "всему Таджикистану"),
    "KG": ("Кыргызстан",   "Кыргызстане",      "всему Кыргызстану"),
    "MN": ("Монголия",     "Монголии",         "всей Монголии"),
    "QA": ("Катар",        "Катаре",           "всему Катару"),
    "BH": ("Бахрейн",      "Бахрейне",         "всему Бахрейну"),
    "KW": ("Кувейт",       "Кувейте",          "всему Кувейту"),
    "OM": ("Оман",         "Омане",            "всему Оману"),
    "LB": ("Ливан",        "Ливане",           "всему Ливану"),
    "RU": ("Россия",       "России",           "всей России"),
}
...
async def process_country_city_pick(callback: CallbackQuery, state: FSMContext):
    ...
    if value == "any":
        ...
        country_dative = data.get("_country_dative", f"всей {country_name}")
        country_iatas = data.get("_country_iatas", [])

        await callback.answer()
        await callback.message.edit_text(
            f"🔍 Буду искать самый дешёвый рейс по {country_dative}",
            parse_mode="HTML",
        )
